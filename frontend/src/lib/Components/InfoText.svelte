<script lang="ts">
    ...
    export let paragraphA: string;
    export let paragraphB: string;
    export let link: string;
</script>



<div class="border rounded-lg shadow p-7 mx-4 md:mx-10">
  ...
  <div class="flex flex-col md:flex-row w-full">
    ...
    <div class="w-full md:w-1/2 mb-4 md:mb-0">
      ...
      <p class="p-4">{paragraphA}</p>
    </div>

    <div class="w-full md:w-1/2">
      <div class="ms-4">
        <img src={image} alt="Topic" class="w-full h-auto">
      </div>
    </div>
  </div>
  ...
  <div class="flex flex-row ms-5 space-x-5">
    <a href={link}>
    ...
    <a href={link} class="mt-4">
      <span class="font-bold text-lg"> Check Out Your Chair Report</span>  
    </a>
  </div>
</div>
