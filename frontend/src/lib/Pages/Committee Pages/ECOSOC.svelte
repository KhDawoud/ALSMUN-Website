<script lang="ts">
    ...
    import TopicA from '../../../assets/Committees/ECOSOC/Topic 1.jpg';
    import TopicB from '../../../assets/Committees/ECOSOC/Topic 2.jpg';
  ...
  <h1 class="text-center font-bold underline text-6xl my-10"> Economic and Social Council </h1>
